...
export default function Footer({ setShowPatchNotes }: FooterProps) {
  return (
    <footer style={{ marginTop: '3rem', borderTop: '1px solid var(--border)', paddingTop: '1.5rem', textAlign: 'center', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
      <p>© {new Date().getFullYear()} Financial Manager v{SYSTEM_VERSION}. Todos os direitos reservados. • <span style={{ color: 'var(--primary)', cursor: 'pointer', textDecoration: 'underline' }} onClick={() => setShowPatchNotes(true)}>Novidades</span></p>
